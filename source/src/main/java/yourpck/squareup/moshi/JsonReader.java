...
public abstract class JsonReader implements Closeable {
    ...
    public static final class Options {
        ...
        final yourpck.okio.Options doubleQuoteSuffix;

        private Options(String[] strings, yourpck.okio.Options doubleQuoteSuffix) {
        ...
        public static Options of(String... strings) {
            try {
                ...
                return new Options(strings.clone(), yourpck.okio.Options.of(result));
            } catch (IOException e) {
