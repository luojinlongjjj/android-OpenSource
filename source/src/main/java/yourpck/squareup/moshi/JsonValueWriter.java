...
final class JsonValueWriter extends JsonWriter {
    ...
    public JsonWriter beginArray() throws IOException {
        ...
        if (stackSize == flattenStackSize && scopes[stackSize - 1] == JsonScope.EMPTY_ARRAY) {
    ...
    public JsonWriter endArray() throws IOException {
        if (peekScope() != JsonScope.EMPTY_ARRAY) {
    ...
    public JsonWriter beginObject() throws IOException {
        ...
        if (stackSize == flattenStackSize && scopes[stackSize - 1] == JsonScope.EMPTY_OBJECT) {
            // Cancel this open. Invert the flatten stack size until this is closed.
            flattenStackSize = ~flattenStackSize;
            return this;
        }
    ...
    public JsonWriter endObject() throws IOException {
        if (peekScope() != JsonScope.EMPTY_OBJECT) {
            throw new IllegalStateException("Nesting problem.");
        }
    ...
    public JsonWriter name(String name) throws IOException {
        ...
        if (peekScope() != JsonScope.EMPTY_OBJECT || deferredName != null) {
            throw new IllegalStateException("Nesting problem.");
        }
        deferredName = name;
    ...
    private JsonValueWriter add(@Nullable Object newTop) {
        ...
        } else if (scope == JsonScope.EMPTY_OBJECT && deferredName != null) {
