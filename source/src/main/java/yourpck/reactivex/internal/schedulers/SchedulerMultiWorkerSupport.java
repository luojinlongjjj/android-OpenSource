 ...
 * {@link yourpck.reactivex.Scheduler} in a way that when asking for
 * at most the parallelism level of the Scheduler, those
 * {@link yourpck.reactivex.Scheduler.Worker} instances will be running
...
public interface SchedulerMultiWorkerSupport {
    ...
    /**
     * Creates the given number of {@link yourpck.reactivex.Scheduler.Worker} instances
