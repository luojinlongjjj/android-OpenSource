...
import yourpck.reactivex.annotations.BackpressureKind;
import yourpck.reactivex.annotations.BackpressureSupport;
import yourpck.reactivex.annotations.CheckReturnValue;
import yourpck.reactivex.annotations.Experimental;
import yourpck.reactivex.annotations.NonNull;
import yourpck.reactivex.annotations.SchedulerSupport;
...
import yourpck.reactivex.functions.BiPredicate;
...
import yourpck.reactivex.functions.Function3;
import yourpck.reactivex.functions.Function4;
import yourpck.reactivex.functions.Function5;
import yourpck.reactivex.functions.Function6;
import yourpck.reactivex.functions.Function7;
import yourpck.reactivex.functions.Function8;
import yourpck.reactivex.functions.Function9;
...
import yourpck.reactivex.internal.observers.BlockingMultiObserver;
import yourpck.reactivex.internal.operators.flowable.FlowableConcatMapPublisher;
import yourpck.reactivex.internal.operators.flowable.FlowableFlatMapPublisher;
import yourpck.reactivex.internal.operators.maybe.MaybeAmb;
import yourpck.reactivex.internal.operators.maybe.MaybeCache;
import yourpck.reactivex.internal.operators.maybe.MaybeCallbackObserver;
import yourpck.reactivex.internal.operators.maybe.MaybeConcatArray;
import yourpck.reactivex.internal.operators.maybe.MaybeConcatArrayDelayError;
import yourpck.reactivex.internal.operators.maybe.MaybeConcatIterable;
import yourpck.reactivex.internal.operators.maybe.MaybeContains;
import yourpck.reactivex.internal.operators.maybe.MaybeCount;
import yourpck.reactivex.internal.operators.maybe.MaybeCreate;
import yourpck.reactivex.internal.operators.maybe.MaybeDefer;
import yourpck.reactivex.internal.operators.maybe.MaybeDelay;
import yourpck.reactivex.internal.operators.maybe.MaybeDelayOtherPublisher;
import yourpck.reactivex.internal.operators.maybe.MaybeDelaySubscriptionOtherPublisher;
import yourpck.reactivex.internal.operators.maybe.MaybeDetach;
import yourpck.reactivex.internal.operators.maybe.MaybeDoAfterSuccess;
import yourpck.reactivex.internal.operators.maybe.MaybeDoFinally;
import yourpck.reactivex.internal.operators.maybe.MaybeDoOnEvent;
import yourpck.reactivex.internal.operators.maybe.MaybeDoOnTerminate;
import yourpck.reactivex.internal.operators.maybe.MaybeEmpty;
import yourpck.reactivex.internal.operators.maybe.MaybeEqualSingle;
import yourpck.reactivex.internal.operators.maybe.MaybeError;
import yourpck.reactivex.internal.operators.maybe.MaybeErrorCallable;
import yourpck.reactivex.internal.operators.maybe.MaybeFilter;
import yourpck.reactivex.internal.operators.maybe.MaybeFlatMapBiSelector;
import yourpck.reactivex.internal.operators.maybe.MaybeFlatMapCompletable;
import yourpck.reactivex.internal.operators.maybe.MaybeFlatMapIterableFlowable;
import yourpck.reactivex.internal.operators.maybe.MaybeFlatMapIterableObservable;
import yourpck.reactivex.internal.operators.maybe.MaybeFlatMapNotification;
import yourpck.reactivex.internal.operators.maybe.MaybeFlatMapSingle;
import yourpck.reactivex.internal.operators.maybe.MaybeFlatMapSingleElement;
import yourpck.reactivex.internal.operators.maybe.MaybeFlatten;
import yourpck.reactivex.internal.operators.maybe.MaybeFromAction;
import yourpck.reactivex.internal.operators.maybe.MaybeFromCallable;
import yourpck.reactivex.internal.operators.maybe.MaybeFromCompletable;
import yourpck.reactivex.internal.operators.maybe.MaybeFromFuture;
import yourpck.reactivex.internal.operators.maybe.MaybeFromRunnable;
import yourpck.reactivex.internal.operators.maybe.MaybeFromSingle;
import yourpck.reactivex.internal.operators.maybe.MaybeHide;
import yourpck.reactivex.internal.operators.maybe.MaybeIgnoreElementCompletable;
import yourpck.reactivex.internal.operators.maybe.MaybeIsEmptySingle;
import yourpck.reactivex.internal.operators.maybe.MaybeJust;
import yourpck.reactivex.internal.operators.maybe.MaybeLift;
import yourpck.reactivex.internal.operators.maybe.MaybeMap;
import yourpck.reactivex.internal.operators.maybe.MaybeMaterialize;
import yourpck.reactivex.internal.operators.maybe.MaybeMergeArray;
import yourpck.reactivex.internal.operators.maybe.MaybeNever;
import yourpck.reactivex.internal.operators.maybe.MaybeObserveOn;
import yourpck.reactivex.internal.operators.maybe.MaybeOnErrorComplete;
import yourpck.reactivex.internal.operators.maybe.MaybeOnErrorNext;
import yourpck.reactivex.internal.operators.maybe.MaybeOnErrorReturn;
import yourpck.reactivex.internal.operators.maybe.MaybePeek;
import yourpck.reactivex.internal.operators.maybe.MaybeSubscribeOn;
import yourpck.reactivex.internal.operators.maybe.MaybeSwitchIfEmpty;
import yourpck.reactivex.internal.operators.maybe.MaybeSwitchIfEmptySingle;
import yourpck.reactivex.internal.operators.maybe.MaybeTakeUntilMaybe;
import yourpck.reactivex.internal.operators.maybe.MaybeTakeUntilPublisher;
import yourpck.reactivex.internal.operators.maybe.MaybeTimeoutMaybe;
import yourpck.reactivex.internal.operators.maybe.MaybeTimeoutPublisher;
import yourpck.reactivex.internal.operators.maybe.MaybeTimer;
import yourpck.reactivex.internal.operators.maybe.MaybeToFlowable;
import yourpck.reactivex.internal.operators.maybe.MaybeToObservable;
import yourpck.reactivex.internal.operators.maybe.MaybeToPublisher;
import yourpck.reactivex.internal.operators.maybe.MaybeToSingle;
import yourpck.reactivex.internal.operators.maybe.MaybeUnsafeCreate;
import yourpck.reactivex.internal.operators.maybe.MaybeUnsubscribeOn;
import yourpck.reactivex.internal.operators.maybe.MaybeUsing;
import yourpck.reactivex.internal.operators.maybe.MaybeZipArray;
import yourpck.reactivex.internal.operators.maybe.MaybeZipIterable;
import yourpck.reactivex.internal.operators.mixed.MaybeFlatMapObservable;
import yourpck.reactivex.internal.operators.mixed.MaybeFlatMapPublisher;
import yourpck.reactivex.internal.util.ErrorMode;
import yourpck.reactivex.internal.util.ExceptionHelper;
import yourpck.reactivex.observers.TestObserver;
import yourpck.reactivex.plugins.RxJavaPlugins;
import yourpck.reactivex.schedulers.Schedulers;
 ...
 * {@link yourpck.reactivex.subjects.MaybeSubject MaybeSubject}.
 * <p>
 ...
 *    .delay(10, TimeUnit.SECONDS, Schedulers.yourpck())
 ...
 * {@link yourpck.reactivex.observers.DisposableMaybeObserver DisposableMaybeObserver} instance.
 ...
 * @see yourpck.reactivex.observers.DisposableMaybeObserver
 * @since 2.0
 */
public abstract class Maybe<T> implements MaybeSource<T> {
     ...
     * @param source1 a MaybeSource to be concatenated
     * @param source2 a MaybeSource to be concatenated
     ...
     * @param source1 a MaybeSource to be concatenated
     * @param source2 a MaybeSource to be concatenated
     * @param source3 a MaybeSource to be concatenated
     ...
     * @param source2 a MaybeSource to be concatenated
     * @param source3 a MaybeSource to be concatenated
     * @param source4 a MaybeSource to be concatenated
     ...
     * violates this, a {@link yourpck.reactivex.exceptions.MissingBackpressureException} is signalled.</dd>
     * <dt><b>Scheduler:</b></dt>
     * <dd>{@code concat} does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     *
     ...
     * signal {@link yourpck.reactivex.exceptions.MissingBackpressureException}.</dd>
     * <dt><b>Scheduler:</b></dt>
     * <dd>This method does not operate by default on a particular {@link Scheduler}.</dd>
     * </dl>
     *
     ...
     * </dl>
     *
     * @param exception the particular Throwable to pass to {@link MaybeObserver#onError onError}
     * @param <T>       the type of the item (ostensibly) emitted by the Maybe
     ...
     * </dl>
     *
     * @param supplier a Callable factory to return a Throwable for each individual MaybeObserver
     * @param <T>      the type of the items (ostensibly) emitted by the Maybe
     ...
     * {@link RxJavaPlugins#onError(Throwable)} as an {@link yourpck.reactivex.exceptions.UndeliverableException UndeliverableException}.
     * </dd>
     * </dl>
     *
     ...
     * {@link yourpck.reactivex base reactive classes}. Those operators signal a {@code NullPointerException} if the value returned by their
     ...
     * {@link yourpck.reactivex.plugins.RxJavaPlugins#onError(Throwable)} wrapped into a
     * {@link yourpck.reactivex.exceptions.UndeliverableException UndeliverableException}.
     ...
     * </dl>
     *
     * @param callable a {@link Callable} instance whose execution should be deferred and performed for each individual
     ...
     *
     * @param <T>     the common value type
     * @param source1 a MaybeSource to be merged
     * @param source2 a MaybeSource to be merged
     ...
     * @param source1 a MaybeSource to be merged
     * @param source2 a MaybeSource to be merged
     * @param source3 a MaybeSource to be merged
     * @return a Flowable that emits all of the items emitted by the source MaybeSources
     * @see <a href="http://reactivex.io/documentation/operators/merge.html">ReactiveX operators documentation: Merge</a>
     ...
     * @param source2 a MaybeSource to be merged
     * @param source3 a MaybeSource to be merged
     * @param source4 a MaybeSource to be merged
     * @return a Flowable that emits all of the items emitted by the source MaybeSources
     * @see <a href="http://reactivex.io/documentation/operators/merge.html">ReactiveX operators documentation: Merge</a>
     ...
     *
     * @param <T>     the common element base type
     * @param sources the Iterable of MaybeSources
     ...
     *
     * @param <T>     the common element base type
     * @param sources a Publisher that emits MaybeSources
     ...
     * </dl>
     *
     * @param <T> the type of items (not) emitted by the Maybe
     ...
     * </dl>
     *
     * @param source1 the first MaybeSource to compare
     * @param source2 the second MaybeSource to compare
     * @param <T>     the type of items emitted by each MaybeSource
     ...
     * @param source1 the first MaybeSource to compare
     * @param source2 the second MaybeSource to compare
     * @param isEqual a function used to compare items emitted by each MaybeSource
     * @param <T>     the type of items emitted by each MaybeSource
     ...
     * @param resourceSupplier the factory function to create a resource object that depends on the Maybe
     * @param sourceSupplier   the factory function to create a MaybeSource
     ...
     * @param sources an Iterable of source MaybeSources
     * @param zipper  a function that, when applied to an item emitted by each of the source MaybeSources, results in
     ...
     * @param <R>     the zipped result type
     * @param source1 the first source MaybeSource
     * @param source2 a second source MaybeSource
     * @param zipper  a function that, when applied to an item emitted by each of the source MaybeSources, results
     ...
     * @param source1 the first source MaybeSource
     * @param source2 a second source MaybeSource
     * @param source3 a third source MaybeSource
     * @param zipper  a function that, when applied to an item emitted by each of the source MaybeSources, results in
     *                an item that will be emitted by the resulting Maybe
     * @return a Maybe that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source2 a second source MaybeSource
     * @param source3 a third source MaybeSource
     * @param source4 a fourth source MaybeSource
     * @param zipper  a function that, when applied to an item emitted by each of the source MaybeSources, results in
     *                an item that will be emitted by the resulting Maybe
     * @return a Maybe that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source3 a third source MaybeSource
     * @param source4 a fourth source MaybeSource
     * @param source5 a fifth source MaybeSource
     * @param zipper  a function that, when applied to an item emitted by each of the source MaybeSources, results in
     *                an item that will be emitted by the resulting Maybe
     * @return a Maybe that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source4 a fourth source MaybeSource
     * @param source5 a fifth source MaybeSource
     * @param source6 a sixth source MaybeSource
     * @param zipper  a function that, when applied to an item emitted by each of the source MaybeSources, results in
     *                an item that will be emitted by the resulting Maybe
     * @return a Maybe that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source5 a fifth source MaybeSource
     * @param source6 a sixth source MaybeSource
     * @param source7 a seventh source MaybeSource
     * @param zipper  a function that, when applied to an item emitted by each of the source MaybeSources, results in
     *                an item that will be emitted by the resulting Maybe
     * @return a Maybe that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source6 a sixth source MaybeSource
     * @param source7 a seventh source MaybeSource
     * @param source8 an eighth source MaybeSource
     * @param zipper  a function that, when applied to an item emitted by each of the source MaybeSources, results in
     *                an item that will be emitted by the resulting Maybe
     * @return a Maybe that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source7 a seventh source MaybeSource
     * @param source8 an eighth source MaybeSource
     * @param source9 a ninth source MaybeSource
     * @param zipper  a function that, when applied to an item emitted by each of the source MaybeSources, results in
     ...
     * @param sources an array of source MaybeSources
     * @param zipper  a function that, when applied to an item emitted by each of the source MaybeSources, results in
     *                an item that will be emitted by the resulting MaybeSource
     * @return a Maybe that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * </dl>
     *
     * @param other a MaybeSource competing to react first. A subscription to this provided source will occur after
     ...
     * @param mapper a function that, when applied to the item emitted by the source Maybe, returns a MaybeSource
     ...
     * </dl>
     *
     * @param other a MaybeSource to be concatenated after the current
     * @return a Flowable that emits items emitted by the two source MaybeSources, one after the other,
     ...
     * </dl>
     *
     * @param item the item to search for in the emissions from the source Maybe, not null
     ...
     * </dl>
     *
     * @param defaultItem the item to emit if the source Maybe emits no items
     ...
     * @param delayIndicator the Publisher that gets subscribed to when this Maybe signals an event and that
     ...
     * </dl>
     *
     * @param onAfterTerminate an {@link Action} to be invoked when the source Maybe finishes
     ...
     * </dl>
     *
     * @param onComplete the action to invoke when the source Maybe calls {@code onComplete}
     ...
     * </dl>
     *
     * @param predicate a function that evaluates the item emitted by the source Maybe, returning {@code true}
     ...
     *
     * @param <R>                the result type
     * @param onSuccessMapper    a function that returns a MaybeSource to merge for the onSuccess item emitted by this Maybe
     * @param onErrorMapper      a function that returns a MaybeSource to merge for an onError notification from this Maybe
     * @param onCompleteSupplier a function that returns a MaybeSource to merge for an onComplete notification this Maybe
     * @return the new Maybe instance
     * @see <a href="http://reactivex.io/documentation/operators/flatmap.html">ReactiveX operators documentation: FlatMap</a>
     */
    @CheckReturnValue
     ...
     * </dl>
     *
     * @param <U>            the type of items emitted by the MaybeSource returned by the {@code mapper} function
     * @param <R>            the type of items emitted by the resulting Maybe
     * @param mapper         a function that returns a MaybeSource for the item emitted by the source Maybe
     * @param resultSelector a function that combines one item emitted by each of the source and collection MaybeSource and
     ...
     *
     * @param <R>    the result value type
     * @param mapper a function that, when applied to the item emitted by the source Maybe, returns an ObservableSource
     ...
     *
     * @param <R>    the result value type
     * @param mapper a function that, when applied to the item emitted by the source Maybe, returns a
     *               Flowable
     ...
     *
     * @param <R>    the result value type
     * @param mapper a function to apply to the item emitted by the Maybe
     ...
     * </dl>
     *
     * @param other a MaybeSource to be merged
     ...
     * @param clazz the class type to filter the items emitted by the source Maybe
     * @return the new Maybe instance
     * @see <a href="http://reactivex.io/documentation/operators/filter.html">ReactiveX operators documentation: Filter</a>
     */
    @CheckReturnValue
     ...
     * </dl>
     *
     * @param next the next {@code MaybeSource} that will take over if the source Maybe encounters
     *             an error
     * @return the new Maybe instance
     ...
     * </dl>
     *
     * @param resumeFunction a function that returns a MaybeSource that will take over if the source Maybe encounters
     *                       an error
     * @return the new Maybe instance
     * @see <a href="http://reactivex.io/documentation/operators/catch.html">ReactiveX operators documentation: Catch</a>
     */
     ...
     * </dl>
     *
     * @param valueSupplier a function that returns a single value that will be emitted as success value
     ...
     * </dl>
     *
     * @param item the value that is emitted as onSuccess in case this Maybe signals an onError
     * @return the new Maybe instance
     * @see <a href="http://reactivex.io/documentation/operators/catch.html">ReactiveX operators documentation: Catch</a>
     */
    @CheckReturnValue
     ...
     * </dl>
     *
     * @param next the next MaybeSource that will take over if the source Maybe encounters
     *             an exception
     * @return the new Maybe instance
     * @see <a href="http://reactivex.io/documentation/operators/catch.html">ReactiveX operators documentation: Catch</a>
     */
     ...
     * </dl>
     *
     * @param times the number of times the source Maybe items are repeated, a count of 0 will yield an empty
     *              sequence
     ...
     * </dl>
     *
     * @param count the number of times to resubscribe if the current Maybe fails
     * @return the new Maybe instance
     * @see <a href="http://reactivex.io/documentation/operators/retry.html">ReactiveX operators documentation: Retry</a>
     */
    @CheckReturnValue
     ...
     * {@link yourpck.reactivex.exceptions.OnErrorNotImplementedException OnErrorNotImplementedException}
     ...
     * </dl>
     *
     * @param onSuccess the {@code Consumer<T>} you have designed to accept a success value from the Maybe
     * @return a {@link Disposable} reference with which the caller can stop receiving items before
     * the Maybe has finished sending them
     * @throws NullPointerException if {@code onSuccess} is null
     * @see <a href="http://reactivex.io/documentation/operators/subscribe.html">ReactiveX operators documentation: Subscribe</a>
     */
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
     ...
     * @return a {@link Disposable} reference with which the caller can stop receiving items before
     * the Maybe has finished sending them
     * @throws NullPointerException if {@code onSuccess} is null, or
     ...
     * </dl>
     *
     * @param other the alternate MaybeSource to subscribe to if the main does not emit any items
     ...
     *
     * @param other the alternate SingleSource to subscribe to if the main does not emit any items
     ...
     * </dl>
     *
     * @param other the MaybeSource whose first emitted item will cause {@code takeUntil} to stop emitting items
     ...
     * @param timeUnit the unit of time that applies to the {@code timeout} argument
     * @param fallback the fallback MaybeSource to use in case of a timeout
     * @return the new Maybe instance
     * @see <a href="http://reactivex.io/documentation/operators/timeout.html">ReactiveX operators documentation: Timeout</a>
     */
    @CheckReturnValue
     ...
     * @param timeout   maximum duration between items before a timeout occurs
     * @param timeUnit  the unit of time that applies to the {@code timeout} argument
     * @param fallback  the MaybeSource to use as the fallback in case of a timeout
     ...
     * </dl>
     *
     * @param <U>    the type of items emitted by the {@code other} MaybeSource
     * @param <R>    the type of items emitted by the resulting Maybe
     * @param other  the other MaybeSource
     * @param zipper a function that combines the pairs of items from the two MaybeSources to generate the items to
