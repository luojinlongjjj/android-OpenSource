...
import yourpck.reactivex.internal.fuseable.FuseToMaybe;
import yourpck.reactivex.internal.fuseable.FuseToObservable;
import yourpck.reactivex.internal.observers.BiConsumerSingleObserver;
import yourpck.reactivex.internal.observers.BlockingMultiObserver;
import yourpck.reactivex.internal.observers.ConsumerSingleObserver;
import yourpck.reactivex.internal.observers.FutureSingleObserver;
import yourpck.reactivex.internal.operators.completable.CompletableFromSingle;
import yourpck.reactivex.internal.operators.completable.CompletableToFlowable;
...
import yourpck.reactivex.internal.operators.flowable.FlowableSingleSingle;
import yourpck.reactivex.internal.operators.maybe.MaybeFilterSingle;
import yourpck.reactivex.internal.operators.maybe.MaybeFromSingle;
import yourpck.reactivex.internal.operators.mixed.SingleFlatMapObservable;
import yourpck.reactivex.internal.operators.observable.ObservableConcatMap;
import yourpck.reactivex.internal.operators.observable.ObservableSingleSingle;
import yourpck.reactivex.internal.operators.single.SingleAmb;
import yourpck.reactivex.internal.operators.single.SingleCache;
import yourpck.reactivex.internal.operators.single.SingleContains;
import yourpck.reactivex.internal.operators.single.SingleCreate;
import yourpck.reactivex.internal.operators.single.SingleDefer;
import yourpck.reactivex.internal.operators.single.SingleDelay;
import yourpck.reactivex.internal.operators.single.SingleDelayWithCompletable;
import yourpck.reactivex.internal.operators.single.SingleDelayWithObservable;
import yourpck.reactivex.internal.operators.single.SingleDelayWithPublisher;
import yourpck.reactivex.internal.operators.single.SingleDelayWithSingle;
import yourpck.reactivex.internal.operators.single.SingleDematerialize;
import yourpck.reactivex.internal.operators.single.SingleDetach;
import yourpck.reactivex.internal.operators.single.SingleDoAfterSuccess;
import yourpck.reactivex.internal.operators.single.SingleDoAfterTerminate;
import yourpck.reactivex.internal.operators.single.SingleDoFinally;
import yourpck.reactivex.internal.operators.single.SingleDoOnDispose;
import yourpck.reactivex.internal.operators.single.SingleDoOnError;
import yourpck.reactivex.internal.operators.single.SingleDoOnEvent;
import yourpck.reactivex.internal.operators.single.SingleDoOnSubscribe;
import yourpck.reactivex.internal.operators.single.SingleDoOnSuccess;
import yourpck.reactivex.internal.operators.single.SingleDoOnTerminate;
import yourpck.reactivex.internal.operators.single.SingleEquals;
import yourpck.reactivex.internal.operators.single.SingleError;
import yourpck.reactivex.internal.operators.single.SingleFlatMap;
import yourpck.reactivex.internal.operators.single.SingleFlatMapCompletable;
import yourpck.reactivex.internal.operators.single.SingleFlatMapIterableFlowable;
import yourpck.reactivex.internal.operators.single.SingleFlatMapIterableObservable;
import yourpck.reactivex.internal.operators.single.SingleFlatMapMaybe;
import yourpck.reactivex.internal.operators.single.SingleFlatMapPublisher;
import yourpck.reactivex.internal.operators.single.SingleFromCallable;
import yourpck.reactivex.internal.operators.single.SingleFromPublisher;
import yourpck.reactivex.internal.operators.single.SingleFromUnsafeSource;
import yourpck.reactivex.internal.operators.single.SingleHide;
import yourpck.reactivex.internal.operators.single.SingleInternalHelper;
import yourpck.reactivex.internal.operators.single.SingleJust;
import yourpck.reactivex.internal.operators.single.SingleLift;
import yourpck.reactivex.internal.operators.single.SingleMap;
import yourpck.reactivex.internal.operators.single.SingleMaterialize;
import yourpck.reactivex.internal.operators.single.SingleNever;
import yourpck.reactivex.internal.operators.single.SingleObserveOn;
import yourpck.reactivex.internal.operators.single.SingleOnErrorReturn;
import yourpck.reactivex.internal.operators.single.SingleResumeNext;
import yourpck.reactivex.internal.operators.single.SingleSubscribeOn;
import yourpck.reactivex.internal.operators.single.SingleTakeUntil;
import yourpck.reactivex.internal.operators.single.SingleTimeout;
import yourpck.reactivex.internal.operators.single.SingleTimer;
import yourpck.reactivex.internal.operators.single.SingleToFlowable;
import yourpck.reactivex.internal.operators.single.SingleToObservable;
import yourpck.reactivex.internal.operators.single.SingleUnsubscribeOn;
import yourpck.reactivex.internal.operators.single.SingleUsing;
import yourpck.reactivex.internal.operators.single.SingleZipArray;
import yourpck.reactivex.internal.operators.single.SingleZipIterable;
 ...
 * {@link yourpck.reactivex.subjects.SingleSubject SingleSubject}.
 * <p>
 ...
 * {@link yourpck.reactivex.observers.DisposableSingleObserver DisposableSingleObserver} instance.
 ...
 * @see yourpck.reactivex.observers.DisposableSingleObserver
 * @since 2.0
 */
public abstract class Single<T> implements SingleSource<T> {
     ...
     * @param source1 a Single to be concatenated
     * @param source2 a Single to be concatenated
     ...
     * @param source1 a Single to be concatenated
     * @param source2 a Single to be concatenated
     * @param source3 a Single to be concatenated
     ...
     * @param source2 a Single to be concatenated
     * @param source3 a Single to be concatenated
     * @param source4 a Single to be concatenated
     ...
     * </dl>
     *
     * @param exception the particular Throwable to pass to {@link SingleObserver#onError onError}
     ...
     * </dl>
     *
     * @param callable function which execution should be deferred, it will be invoked when SingleObserver will subscribe to the {@link Single}.
     ...
     * @param timeout   the maximum time to wait before calling {@code get}
     * @param unit      the {@link TimeUnit} of the {@code timeout} argument
     * @param scheduler the Scheduler to use for the blocking wait
     * @param <T>       the type of object that the {@link Future} returns, and also the type of item to be emitted by
     *                  the resulting {@code Single}
     * @return a {@code Single} that emits the item from the source {@link Future}
     * @see <a href="http://reactivex.io/documentation/operators/from.html">ReactiveX operators documentation: From</a>
     ...
     *
     * @param <T>     the common value type
     * @param source1 a SingleSource to be merged
     * @param source2 a SingleSource to be merged
     ...
     * @param source1 a SingleSource to be merged
     * @param source2 a SingleSource to be merged
     * @param source3 a SingleSource to be merged
     * @return a Flowable that emits all of the items emitted by the source Singles
     * @see <a href="http://reactivex.io/documentation/operators/merge.html">ReactiveX operators documentation: Merge</a>
     ...
     * @param source2 a SingleSource to be merged
     * @param source3 a SingleSource to be merged
     * @param source4 a SingleSource to be merged
     * @return a Flowable that emits all of the items emitted by the source Singles
     * @see <a href="http://reactivex.io/documentation/operators/merge.html">ReactiveX operators documentation: Merge</a>
     ...
     * @return the new Single instance
     * @throws NullPointerException if unit is null, or
     ...
     *                         that particular resource when the generated SingleSource terminates
     *                         (successfully or with an error) or gets disposed.
     * @param eager            if true, the disposer is called before the terminal event is signalled
     ...
     * @param <R>     the result value type
     * @param source1 the first source Single
     * @param source2 a second source Single
     * @param zipper  a function that, when applied to the item emitted by each of the source Singles, results in an
     ...
     * @param source1 the first source Single
     * @param source2 a second source Single
     * @param source3 a third source Single
     * @param zipper  a function that, when applied to the item emitted by each of the source Singles, results in an
     *                item that will be emitted by the resulting Single
     * @return a Single that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source2 a second source Single
     * @param source3 a third source Single
     * @param source4 a fourth source Single
     * @param zipper  a function that, when applied to the item emitted by each of the source Singles, results in an
     *                item that will be emitted by the resulting Single
     * @return a Single that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source3 a third source Single
     * @param source4 a fourth source Single
     * @param source5 a fifth source Single
     * @param zipper  a function that, when applied to the item emitted by each of the source Singles, results in an
     *                item that will be emitted by the resulting Single
     * @return a Single that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source4 a fourth source Single
     * @param source5 a fifth source Single
     * @param source6 a sixth source Single
     * @param zipper  a function that, when applied to the item emitted by each of the source Singles, results in an
     *                item that will be emitted by the resulting Single
     * @return a Single that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source5 a fifth source Single
     * @param source6 a sixth source Single
     * @param source7 a seventh source Single
     * @param zipper  a function that, when applied to the item emitted by each of the source Singles, results in an
     *                item that will be emitted by the resulting Single
     * @return a Single that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source6 a sixth source Single
     * @param source7 a seventh source Single
     * @param source8 an eighth source Single
     * @param zipper  a function that, when applied to the item emitted by each of the source Singles, results in an
     *                item that will be emitted by the resulting Single
     * @return a Single that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * @param source7 a seventh source Single
     * @param source8 an eighth source Single
     * @param source9 a ninth source Single
     * @param zipper  a function that, when applied to the item emitted by each of the source Singles, results in an
     *                item that will be emitted by the resulting Single
     * @return a Single that emits the zipped results
     * @see <a href="http://reactivex.io/documentation/operators/zip.html">ReactiveX operators documentation: Zip</a>
     ...
     * </dl>
     *
     * @param other a Single to be concatenated after the current
     ...
     *
     * @param onAfterTerminate an {@link Action} to be invoked when the source Single finishes
     ...
     *
     * @param <R>    the result value type
     * @param mapper a function that, when applied to the item emitted by the source Single, returns a SingleSource
     ...
     *
     * @param <R>    the result value type
     * @param mapper a function that, when applied to the item emitted by the source Single, returns a MaybeSource
     ...
     *
     * @param <R>    the result value type
     * @param mapper a function that, when applied to the item emitted by the source Single, returns a
     *               Flowable
     ...
     *
     * @param <R>    the result value type
     * @param mapper a function that, when applied to the item emitted by the source Single, returns an ObservableSource
     ...
     *
     * @param <R>    the result value type
     * @param mapper a function to apply to the item emitted by the Single
     ...
     * </dl>
     *
     * @param other a SingleSource to be merged
     ...
     * </dl>
     *
     * @param resumeFunction a function that returns an item that the new Single will emit if the source Single encounters
     *                       an error
     ...
     * </dl>
     *
     * @param onCallback the callback that receives either the success value or the failure Throwable
     *                   (whichever is not null)
     * @return a {@link Disposable} reference can request the {@link Single} stop work.
     * @throws NullPointerException if {@code onCallback} is null
     * @see <a href="http://reactivex.io/documentation/operators/subscribe.html">ReactiveX operators documentation: Subscribe</a>
     */
    @CheckReturnValue
    @NonNull
     ...
     * </dl>
     *
     * @param onSuccess the {@code Consumer<T>} you have designed to accept the emission from the Single
     * @return a {@link Disposable} reference can request the {@link Single} stop work.
     ...
     * </dl>
     *
     * @param other the Completable whose termination will cause {@code takeUntil} to emit the item from the source
     *              Single
     ...
     * </dl>
     *
     * @param other the Publisher whose first emitted item will cause {@code takeUntil} to emit the item from the source
     *              Single
     ...
     * @param other   the other SingleSource that gets subscribed to if the current Single times out
     * @return the new Single instance
     * @throws NullPointerException if other is null, or
     *                              if unit is null, or
     *                              if scheduler is null
     * @since 2.0
     */
     ...
     * </dl>
     *
     * @param <U>    the type of items emitted by the {@code other} Single
     * @param <R>    the type of items emitted by the resulting Single
     * @param other  the other SingleSource
     * @param zipper a function that combines the pairs of items from the two SingleSources to generate the items to
