...
package yourpck.reactivex.flowables;
...
import yourpck.reactivex.internal.operators.flowable.FlowableAutoConnect;
import yourpck.reactivex.internal.operators.flowable.FlowableRefCount;
import yourpck.reactivex.internal.util.ConnectConsumer;
 ...
 *
 * @param <T> the type of items emitted by the {@code ConnectableFlowable}
...
public abstract class ConnectableFlowable<T> extends Flowable<T> {
     ...
     *
     * @param connection the action that receives the connection subscription before the subscription to source happens
     ...
     * {@link Flowable} to its {@link Subscriber}s.
     * <p>
     * To disconnect from a synchronous source, use the {@link #connect(yourpck.reactivex.functions.Consumer)} method.
     *
