...
package yourpck.reactivex.annotations;
...
public @interface SchedulerSupport {
     ...
     */
    String NEW_THREAD = "yourpck.reactivex:new-thread";
    /**
     * The operator/class runs on RxJava's {@linkplain Schedulers#trampoline() trampoline scheduler}
     * or takes timing information from it.
     */
    String TRAMPOLINE = "yourpck.reactivex:trampoline";
    /**
     ...
     * @since 2.2
     */
    String SINGLE = "yourpck.reactivex:single";
