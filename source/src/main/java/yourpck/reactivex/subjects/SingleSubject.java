 ...
 * <p>
 * Since a {@code SingleSubject} is a {@link yourpck.reactivex.Single}, calling {@code onSuccess} or {@code onError}
 ...
 * the {@link yourpck.reactivex.plugins.RxJavaPlugins#onError(Throwable)} global error handler.
 * <p>
 ...
 * <dl>
 * <dt><b>Scheduler:</b></dt>
 * <dd>{@code SingleSubject} does not operate by default on a particular {@link yourpck.reactivex.Scheduler} and
 ...
 * {@link yourpck.reactivex.plugins.RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code SingleObserver}s
 * cancel at once).
