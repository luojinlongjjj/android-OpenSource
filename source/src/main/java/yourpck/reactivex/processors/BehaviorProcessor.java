 ...
 * <dt><b>Scheduler:</b></dt>
 * <dd>{@code BehaviorProcessor} does not operate by default on a particular {@link yourpck.reactivex.Scheduler} and
...
public final class BehaviorProcessor<T> extends FlowableProcessor<T> {
     ...
     *
     * @param <T> the type of item the BehaviorProcessor will emit
     ...
     *
     * @param <T>          the type of item the BehaviorProcessor will emit
     * @param defaultValue the item that will be emitted first to any {@link Subscriber} as long as the
