...
package yourpck.reactivex.schedulers;
...
import yourpck.reactivex.internal.schedulers.ComputationScheduler;
import yourpck.reactivex.internal.schedulers.ExecutorScheduler;
import yourpck.reactivex.internal.schedulers.IoScheduler;
import yourpck.reactivex.internal.schedulers.NewThreadScheduler;
import yourpck.reactivex.internal.schedulers.SchedulerPoolFactory;
import yourpck.reactivex.internal.schedulers.SingleScheduler;
 ...
 * <ul>
 * <li>{@code rx2.yourpck-keep-alive-time} (long): sets the keep-alive time of the {@link #io()} Scheduler workers, default is {@link IoScheduler#KEEP_ALIVE_TIME_DEFAULT}</li>
 * <li>{@code rx2.yourpck-priority} (int): sets the thread priority of the {@link #io()} Scheduler, default is {@link Thread#NORM_PRIORITY}</li>
...
public final class Schedulers {
     ...
     * <p>
     * This type of scheduler is less sensitive to leaking {@link yourpck.reactivex.Scheduler.Worker} instances, although
     ...
     * {@link RxJavaPlugins#setInitComputationSchedulerHandler(yourpck.reactivex.functions.Function)} plugin method.
     ...
     * via the {@link RxJavaPlugins#setComputationSchedulerHandler(yourpck.reactivex.functions.Function)} method.
     * <p>
     ...
     * &#64;{@link yourpck.reactivex.annotations.SchedulerSupport SchedulerSupport}({@link yourpck.reactivex.annotations.SchedulerSupport#COMPUTATION COMPUTATION})
     * javax.annotation.
     *
     ...
     * returned by {@link yourpck.reactivex.Scheduler#createWorker()} but otherwise will start a new backing
     ...
     * or when implementing an operator, the Worker instances must be disposed via {@link yourpck.reactivex.Scheduler.Worker#dispose()}.
     * <p>
     ...
     * <p>
     * The default value of this scheduler can be overridden at initialization time via the
     * {@link RxJavaPlugins#setInitIoSchedulerHandler(yourpck.reactivex.functions.Function)} plugin method.
     * Note that due to possible initialization cycles, using any of the other scheduler-returning methods will
     * result in a {@code NullPointerException}.
     * Once the {@link Schedulers} class has been initialized, you can override the returned {@link Scheduler} instance
     * via the {@link RxJavaPlugins#setIoSchedulerHandler(yourpck.reactivex.functions.Function)} method.
     * <p>
     * It is possible to create a fresh instance of this scheduler with a custom ThreadFactory, via the
     ...
     * (J2EE) container to unload properly.
     * <p>Operators on the base reactive classes that use this scheduler are marked with the
     * &#64;{@link yourpck.reactivex.annotations.SchedulerSupport SchedulerSupport}({@link yourpck.reactivex.annotations.SchedulerSupport#IO IO})
     * javax.annotation.
     *
    ...
    /**
     * Returns a default, shared {@link Scheduler} instance whose {@link yourpck.reactivex.Scheduler.Worker}
     ...
     * the Worker instances must be disposed via {@link yourpck.reactivex.Scheduler.Worker#dispose()}.
     * <p>
     * Unhandled errors will be delivered to the scheduler Thread's {@link java.lang.Thread.UncaughtExceptionHandler}.
     * <p>
     * You can control certain properties of this standard scheduler via system properties that have to be set
     ...
     * <p>
     * The default value of this scheduler can be overridden at initialization time via the
     * {@link RxJavaPlugins#setInitNewThreadSchedulerHandler(yourpck.reactivex.functions.Function)} plugin method.
     * Note that due to possible initialization cycles, using any of the other scheduler-returning methods will
     * result in a {@code NullPointerException}.
     * Once the {@link Schedulers} class has been initialized, you can override the returned {@link Scheduler} instance
     * via the {@link RxJavaPlugins#setNewThreadSchedulerHandler(yourpck.reactivex.functions.Function)} method.
     * <p>
     * It is possible to create a fresh instance of this scheduler with a custom ThreadFactory, via the
     ...
     * (J2EE) container to unload properly.
     * <p>Operators on the base reactive classes that use this scheduler are marked with the
     * &#64;{@link yourpck.reactivex.annotations.SchedulerSupport SchedulerSupport}({@link yourpck.reactivex.annotations.SchedulerSupport#NEW_THREAD NEW_TRHEAD})
     * javax.annotation.
     *
     ...
     * <p>
     * The default value of this scheduler can be overridden at initialization time via the
     * {@link RxJavaPlugins#setInitSingleSchedulerHandler(yourpck.reactivex.functions.Function)} plugin method.
     * Note that due to possible initialization cycles, using any of the other scheduler-returning methods will
     * result in a {@code NullPointerException}.
     * Once the {@link Schedulers} class has been initialized, you can override the returned {@link Scheduler} instance
     * via the {@link RxJavaPlugins#setSingleSchedulerHandler(yourpck.reactivex.functions.Function)} method.
     * <p>
     * It is possible to create a fresh instance of this scheduler with a custom ThreadFactory, via the
     ...
     * (J2EE) container to unload properly.
     * <p>Operators on the base reactive classes that use this scheduler are marked with the
     * &#64;{@link yourpck.reactivex.annotations.SchedulerSupport SchedulerSupport}({@link yourpck.reactivex.annotations.SchedulerSupport#SINGLE SINGLE})
     * javax.annotation.
     *
     ...
     * {@link yourpck.reactivex.disposables.Disposable#dispose()}. In addition, tasks scheduled with
     * a time delay or periodically will use the {@link #single()} scheduler for the timed waiting
     * before posting the actual task to the given executor.
     * <p>
