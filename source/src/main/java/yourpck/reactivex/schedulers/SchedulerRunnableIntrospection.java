 ...
 * <p>
 * You can check if a {@link Runnable} task submitted to a {@link yourpck.reactivex.Scheduler Scheduler} (or its
 * {@link yourpck.reactivex.Scheduler.Worker Scheduler.Worker}) implements this interface and unwrap the
