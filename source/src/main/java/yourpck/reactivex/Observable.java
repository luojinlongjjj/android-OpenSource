...
import yourpck.reactivex.internal.observers.BlockingFirstObserver;
import yourpck.reactivex.internal.observers.BlockingLastObserver;
import yourpck.reactivex.internal.observers.ForEachWhileObserver;
import yourpck.reactivex.internal.observers.FutureObserver;
import yourpck.reactivex.internal.observers.LambdaObserver;
import yourpck.reactivex.internal.operators.flowable.FlowableFromObservable;
import yourpck.reactivex.internal.operators.flowable.FlowableOnBackpressureError;
import yourpck.reactivex.internal.operators.mixed.ObservableConcatMapCompletable;
import yourpck.reactivex.internal.operators.mixed.ObservableConcatMapMaybe;
import yourpck.reactivex.internal.operators.mixed.ObservableConcatMapSingle;
import yourpck.reactivex.internal.operators.mixed.ObservableSwitchMapCompletable;
import yourpck.reactivex.internal.operators.mixed.ObservableSwitchMapMaybe;
import yourpck.reactivex.internal.operators.mixed.ObservableSwitchMapSingle;
import yourpck.reactivex.internal.operators.observable.*;
import yourpck.reactivex.internal.util.ArrayListSupplier;
import yourpck.reactivex.internal.util.ErrorMode;
import yourpck.reactivex.internal.util.ExceptionHelper;
import yourpck.reactivex.internal.util.HashMapSupplier;
import yourpck.reactivex.observables.ConnectableObservable;
import yourpck.reactivex.observables.GroupedObservable;
import yourpck.reactivex.observers.SafeObserver;
import yourpck.reactivex.observers.TestObserver;
import yourpck.reactivex.plugins.RxJavaPlugins;
import yourpck.reactivex.schedulers.Schedulers;
import yourpck.reactivex.schedulers.Timed;
 ...
 * {@code Subscription} with {@link Disposable} as the primary means to dispose of
 * a flow.
 * <p>
 ...
 * @see Flowable
 * @see yourpck.reactivex.observers.DisposableObserver
 */
public abstract class Observable<T> implements ObservableSource<T> {
     ...
     * @return a Disposable that allows disposing of an asynchronous sequence
     ...
     * <p>Allows hiding extra features such as {@link yourpck.reactivex.subjects.Subject}'s
     ...
     * {@link yourpck.reactivex.exceptions.CompositeException CompositeException}
     ...
     * operator combines all {@code Throwable}s into a {@link yourpck.reactivex.exceptions.CompositeException CompositeException}
     ...
     * {@link yourpck.reactivex.exceptions.CompositeException CompositeException}. Otherwise, a late
     ...
     * {@link yourpck.reactivex.plugins.RxJavaPlugins#onError(Throwable)} as
     * {@link yourpck.reactivex.exceptions.UndeliverableException UndeliverableException}</dd>
     * </dl>
     * <p>History: 2.1.11 - experimental
     *
     * @param <R>    the output value type
