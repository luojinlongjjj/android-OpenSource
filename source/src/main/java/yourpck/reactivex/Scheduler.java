...
import yourpck.reactivex.internal.schedulers.NewThreadWorker;
import yourpck.reactivex.internal.schedulers.SchedulerWhen;
import yourpck.reactivex.internal.util.ExceptionHelper;
import yourpck.reactivex.plugins.RxJavaPlugins;
import yourpck.reactivex.schedulers.SchedulerRunnableIntrospection;
 ...
 * the static methods of the {@link yourpck.reactivex.schedulers.Schedulers} utility class.
 * <p>
 ...
 * <p>
 * Implementations of the {@link #scheduleDirect} and {@link Worker#schedule} methods are encouraged to call the {@link yourpck.reactivex.plugins.RxJavaPlugins#onSchedule(Runnable)}
 ...
 * wrap the incoming {@code Runnable} into a class that implements the {@link yourpck.reactivex.schedulers.SchedulerRunnableIntrospection}
 ...
 * should return the {@link yourpck.reactivex.disposables.Disposables#disposed()} singleton instance indicating the shut down/disposed
...
public abstract class Scheduler {
     ...
     * {@link Flowable#zip(Publisher, Publisher, yourpck.reactivex.functions.BiFunction)} where
     ...
     * should return the {@link yourpck.reactivex.disposables.Disposables#disposed()} singleton instance indicating the disposed
