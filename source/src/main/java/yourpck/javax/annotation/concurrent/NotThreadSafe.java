...
/**
 * The class to which this javax.annotation is applied is not thread-safe. This
 * javax.annotation primarily exists for clarifying the non-thread-safety of a class
